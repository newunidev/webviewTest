...
import 'efficiencyAnalysisBarchar_new.dart';

class EfficiencyAnalysisNew extends StatefulWidget {
  ...
  const EfficiencyAnalysisNew({super.key,required this.passedMonth,required this.passedBranch,required this.passedTargetEfficiency,required this.passedDaysWorked});

  @override
  State<EfficiencyAnalysisNew> createState() => _EfficiencyAnalysisNewState();
}

class _EfficiencyAnalysisNewState extends State<EfficiencyAnalysisNew> {
  var height,width;
  ...
  void initState() {
    ...
    print("Selected Factory checkkk : ${selectedFactory}");
    targetEfficiencyController.text=0.toString();//widget.passedTargetEfficiency.toString();
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 2.0,),
                      Container(
                        height: ConstData.deviceScreenHeight/2.5,
                        ...
                        child: showPieChart
                          ...
                          createPieChartSections: createPieSections,
                            ...
                            : PieChartWidget(createPieChartSections: createPieSections),
                        // Center(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  if(selectedMonthInt!=null && selectedFactory!=null && targetEfficiencyController.text.isNotEmpty && noOfDaysController.text.isNotEmpty){
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(

                                          builder: (context) => EfficiencyAnalysisBar(passedMonth: selectedMonthInt,passedBranch: selectedFactory!,passedTargetEfficiency: double.parse(targetEfficiencyController.text),passedDaysWorked: int.parse(noOfDaysController.text),)//NewLineAnalysisPage(),
                                      ),
                                    );
                                  }
